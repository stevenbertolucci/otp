...
./dec_client ciphertext1 key70000 62310
${echo}
${echo} '#-----------------------------------------'
...
./dec_client ciphertext1 key70000 62311
${echo}
${echo} '#-----------------------------------------'
${echo} '#dec_client ciphertext1 key70000 $decport > plaintext1_a'
./dec_client ciphertext1 key70000 62311 > plaintext1_a
...
rm -f plaintext*_*
./enc_client plaintext1 key70000 62310 > ciphertext1 &
./enc_client plaintext2 key70000 62310 > ciphertext2 &
./enc_client plaintext3 key70000 62310 > ciphertext3 &
./enc_client plaintext4 key70000 62310 > ciphertext4 &
./enc_client plaintext5 key70000 62310 > ciphertext5 &
...
./dec_client ciphertext1 key70000 62311 > plaintext1_a &
./dec_client ciphertext2 key70000 62311 > plaintext2_a &
./dec_client ciphertext3 key70000 62311 > plaintext3_a &
./dec_client ciphertext4 key70000 62311 > plaintext4_a &
${echo} '#Ten second sleep, your program must complete in this time'
sleep 10
ls -pla
